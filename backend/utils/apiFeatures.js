...
//   }
//   paginate() {
//     const numberPage = parseInt(Number(this.queryStr.page));
//     const numberLimit = parseInt(Number(this.queryStr.limit));
//     const page = Math.max(numberPage, 1) || 1;
//     const limit = Math.min(Math.max(numberLimit, 1), 100) || 10;
